...
return [
     ...
     */
    'Security' => [
        'salt' => env('SECURITY_SALT', '3e97856d5ab9420d825a127218bb328081aee9db7d8c5e74cc93b2bd8d3bf7c3'),
    ],
    ...
    'Datasources' => [
        'default' => [
            ...
            'database' => 'restaurant',             // Database name (maps to Oracle's `SERVICE_NAME`)
            'sid' => 'xe',                    // Database System ID (maps to Oracle's `SID`)
